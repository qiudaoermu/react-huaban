    ...
    var Gallery = function (_React$Component) {
        ...
        _createClass(Gallery, [{
            ...
            value: function collect(event, val) {
                ...
                var tabDOM2 = ReactDom.findDOMNode(this.tabDOM);
                console.log(tabDOM2);
                this.setState({ updataFlag: true });
                if (this.state.updataFlag) {
                    var imgmargin = ReactDom.findDOMNode(this.tabDOM);
                    var dialogH = "";
                    var marginH = "";
                    if (imgmargin != null) {
                    ...
                    var dialog = ReactDom.findDOMNode(this.dialogBox);
                    if (dialog != null) {

                        dialogH = window.getComputedStyle(dialog).height;
                        var margintop = parseInt(dialogH) - parseInt(marginH);
                        ...
                        React.createElement(
                            ...
                            React.createElement(
                                ...
                                React.createElement(
                                    ...
                                    React.createElement(
                                        'div',
                                        { className: 'preview', style: { paddingTop: this.state.marignTop + "px" } },
                                        React.createElement(
                                            'div',
                                            { className: 'image' },
...
//# sourceMappingURL=0.cb7a99a8099cb1c9f7b7.hot-update.js.map