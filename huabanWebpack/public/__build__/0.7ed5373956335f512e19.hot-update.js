        ...
        _createClass(Gallery, [{
            ...
            value: function showZoomLayer(v, e) {
                ...
                setTimeout(function () {
                    ...
                    if (imgmargin) {
                        marginw = window.getComputedStyle(imgmargin).height;
                    }
                    console.log(marginw);
                    var paddingTop = ($(window).height() - parseInt(marginw)) / 2;
                    if (paddingTop > 0) {
...
//# sourceMappingURL=0.7ed5373956335f512e19.hot-update.js.map