        ...
        _createClass(Gallery, [{
            ...
            value: function showDetialModel(v, e) {
                ...
                setTimeout(function () {
                    ...
                    if (deTailMaimImg) {
                        imgWidth = window.getComputedStyle(deTailMaimImgWidth).width;
                    }

                    var wM = $(".main-part").width() - parseInt(imgWidth);
                    if (wM > 0) {
                        console.log(wM);
                        this_.setState({ detailMainImgWidth: 700 });
                    } else {
                        this_.setState({ detailMainImgWidth: wM });
                    }
                }, 0);
            }
        }, {
            ...
            value: function render() {
                ...
                return React.createElement(
                                        ...
                                        React.createElement(
                                            ...
                                            React.createElement(
                                                ...
                                                React.createElement('img', {
                                                    ...
                                                    width: this.states.detailMainImgWidth,
                                                    alt: 'MODERATEDesign',
                                                    'data-baiduimageplus-ignore': '1'
                                                })
                                            )
                    ...
                    this.state.showZoomLayer ? React.createElement(
                        'div',
                        {
                            'data-img': '//hbimg.b0.upaiyun.com/1eae055fc17b7778c6b6a35f5060b7bfb4b7bdd710349-1GWAoL',
                            className: 'zoom-layer' },
                        React.createElement(
                            'div',
                            { className: 'holder', style: { paddingTop: this.state.ZoomLayerPaddinTop } },
                            React.createElement('img', {
...
//# sourceMappingURL=0.3e36429b694b8d38033a.hot-update.js.map