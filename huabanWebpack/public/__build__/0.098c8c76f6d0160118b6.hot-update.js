...
var UserInfo = function (_React$Component) {
    ...
    function UserInfo() {
        ...
        $.ajax({
            ...
            this_.setState({ callbackData: data[0].boards });
            console.log(this_.state.callbackData);
        });
        return _this;
    }
                ...
                _react2.default.createElement(
                    ...
                    _react2.default.createElement(
                        ...
                        this.state.callbackData.map(function (v, i) {
                            return _react2.default.createElement(
                                'div',
                                { 'data-id': v.board_id, 'data-seq': v.board_id, className: 'Board wfc inited' },
                                ...
                                _react2.default.createElement(
                                    ...
                                    _react2.default.createElement('img', { src: "//hbimg.b0.upaiyun.com/" + v.pins[0].file.key,
...
//# sourceMappingURL=0.098c8c76f6d0160118b6.hot-update.js.map