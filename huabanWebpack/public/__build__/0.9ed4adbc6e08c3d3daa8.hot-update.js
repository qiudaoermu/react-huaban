    ...
    var Gallery = function (_React$Component) {
        ...
        _createClass(Gallery, [{
            ...
            value: function collect(v, e) {
                ...
                setTimeout(function () {
                    if (this_.state.updataFlag) {
                        var _imgmargin = ReactDom.findDOMNode(this_.tabDOM);
                        var dialogH = "";
                        var marginH = "";

                        marginH = window.getComputedStyle(_imgmargin).height;
            ...
            value: function showDetialModel(v, e) {
                ...
                setTimeout(function () {
                    var deTailMaimImgWidth = ReactDom.findDOMNode(this_.deTailMaimImgWidth);
                    var dialogH = "";
                    var marginH = "";

                    if (imgmargin) {
                        marginH = window.getComputedStyle(deTailMaimImgWidth).width;
                    }
...
//# sourceMappingURL=0.9ed4adbc6e08c3d3daa8.hot-update.js.map