    ...
    var Gallery = function (_React$Component) {
        ...
        function Gallery() {
            ...
            $.ajax({
                ...
                console.log(data);
                callBackData = data;
                for (var i = 0; i < callBackData[0].pins.length; i++) {
            ...
            console.log(_this.props.data - flagLoading);
                ...
                $(window).scroll(function (e) {
                    if ($(window).scrollTop() + $(window).height() + 2250 >= $(document).height()) {
                        ...
                        if (this_.state.loadDataFlag == false) {
                            ...
                            setTimeout(function () {
                                a++;
                                for (var i = 0; i < callBackData[a].pins.length; i++) {
                                    dataR.push(callBackData[a].pins[i]);
                                }
...
//# sourceMappingURL=0.7c582ecba39ef3bd44d3.hot-update.js.map