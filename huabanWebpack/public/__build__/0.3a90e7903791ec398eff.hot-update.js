...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_3_history_createMemoryHistory__ = __webpack_require__(206);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_4_history__ = __webpack_require__(211);
function _classCallCheck(instance, Constructor) { if (!(instance instanceof Constructor)) { throw new TypeError("Cannot call a class as a function"); } }
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_3_invariant__ = __webpack_require__(17);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_3_invariant___default = __webpack_require__.n(__WEBPACK_IMPORTED_MODULE_3_invariant__);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_4__matchPath__ = __webpack_require__(59);
function _classCallCheck(instance, Constructor) { if (!(instance instanceof Constructor)) { throw new TypeError("Cannot call a class as a function"); } }
...
var _Detail = __webpack_require__(!(function webpackMissingModule() { var e = new Error("Cannot find module \"../components/Detail\""); e.code = 'MODULE_NOT_FOUND'; throw e; }()));
...
(function () {
    ...
    var Masonry = __webpack_require__(229);
    ...
    var Gallery = function (_React$Component) {
        ...
        _createClass(Gallery, [{
                ...
                setTimeout(function () {
                    if (this_.state.updataFlag) {
                        ...
                        if (dialog != null) {
                            ...
                            var margintop = (parseInt(dialogH) - $(".colloctMainImg").height()) / 2;
            ...
            key: 'showDetialModel',
            value: function showDetialModel(v, e) {
                ...
                setTimeout(function () {
                    ...
                    var deTailMaimImg = ReactDom.findDOMNode(this_.deTailMaimImgWidth);
                    ...
                    var wM = $(".main-part").width() - parseInt(imgWidth);
                    if (wM > 0) {
            ...
            key: 'closeDetailMode',
            value: function closeDetailMode() {
                this.setState({ showDetailModel: false });
            }
        }, {
            key: 'showZoomLayer',
            value: function showZoomLayer(v, e) {
                this.setState({ ZoomLayerImg: v });
                this.setState({ showZoomLayer: true });

                var this_ = this;
                setTimeout(function () {
                    var imgmargin = ReactDom.findDOMNode(this_.zoomLayer);
                    var dialogH = "";
                    var marginH = "";
                    ...
                    var paddingTop = ($(window).height() - parseInt(marginH)) / 2;
                    if (paddingTop > 0) {
            ...
            key: 'closeZoomLayer',
            value: function closeZoomLayer(v, e) {
            ...
            value: function render() {
                ...
                return React.createElement(
                    ...
                    this.state.showDetailModel ? React.createElement(
                        ...
                        React.createElement(
                            'div',
                            { className: 'close-layer', onClick: this.closeDetailMode.bind(this) },
                            React.createElement('i', null)
                        ),
                        React.createElement(
                            'div',
                                    ...
                                    React.createElement(
                                        ...
                                        React.createElement(
                                            ...
                                            React.createElement(
                                                ...
                                                React.createElement('img', { src: 'public/css/img/loading.gif' }),
                                                React.createElement(
                                                    'span',
                                                    null,
                                                    '\u6B63\u5728\u52A0\u8F7D...'
                    ...
                    this.state.showZoomLayer ? React.createElement(
                        'div',
                        {
                        ...
                        React.createElement(
                            ...
                            React.createElement('img', {
                                ...
                                ref: function ref(dom) {
                                    _this2.zoomLayer = dom;
                                }

                            })
                        ),
                        React.createElement('div', { className: 'close-zoom', onClick: this.closeZoomLayer.bind(this) })
                    ) : "",
                    React.createElement(
                        'div',
...
var Masonry = isBrowser ? window.Masonry || __webpack_require__(230) : null;
var imagesloaded = isBrowser ? __webpack_require__(235) : null;
var assign = __webpack_require__(236);
var elementResizeDetectorMaker = __webpack_require__(237);
var debounce = __webpack_require__(248);
var omit = __webpack_require__(249);
var PropTypes = __webpack_require__(16);
var React = __webpack_require__(13);
var createReactClass = __webpack_require__(250);
...
// -------------------------- masonryDefinition -------------------------- //
  ...
  proto._getItemLayoutPosition = function( item ) {
    ...
    // position the brick
    var position = {
      x: this.columnWidth * colPosition.col+colPosition.col*16,
      y: colPosition.y+20
    };
...
var forEach                 = __webpack_require__(223).forEach;
var elementUtilsMaker       = __webpack_require__(238);
var listenerHandlerMaker    = __webpack_require__(239);
var idGeneratorMaker        = __webpack_require__(240);
var idHandlerMaker          = __webpack_require__(241);
var reporterMaker           = __webpack_require__(242);
var browserDetector         = __webpack_require__(224);
...
//# sourceMappingURL=0.3a90e7903791ec398eff.hot-update.js.map