    ...
    var Gallery = function (_React$Component) {
        ...
        _createClass(Gallery, [{
            ...
            value: function componentDidUpdate() {
                ...
                if (imgmargin != null) {
                    console.log(window.getComputedStyle(imgmargin).height);
                }
                var dialog = ReactDom.findDOMNode(this.dialogBox);
                if (dialog != null) {
                    console.log(window.getComputedStyle(dialog).height);
                }
            }
        }, {
            key: 'mouseShowAction',
...
//# sourceMappingURL=0.98cd68de639cb2b2cc74.hot-update.js.map